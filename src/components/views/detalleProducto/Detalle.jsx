 ...
 useEffect(() => {
    obtenerProductosEditar(id)
      .then((respuesta) => {
        if (respuesta) {
          ...
          console.log("El producto no se encontró. Redirigiendo a la página de error...");
          navegacion("/error");
        }
      })
      .catch((error) => {
        console.error("Error al obtener el producto:", error);
        // Si hay un error al obtener el producto, también redirigir a la página de error.
        navegacion("/error");
      });
  }, [id, navegacion]);
    ...
    return (
        <Container className='mainSection'>
            ...
            <img // Agrega una imagen predeterminada o un valor de imagen por defecto.
              src={notImage}
              className="p-md-3 colorBorde rounded-4 imgDetail"
